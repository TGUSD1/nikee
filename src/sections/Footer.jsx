    ...
    <footer className="max-container">
                ...
                <div key={section}>
                  ...
                  <ul>
                    {section.links.map((link) => (
                      <li className="mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-red-500 cursor-pointer" key={link.name}>
                        <a href="">{link.name}</a>
                      </li>
                    ))}
                  </ul>
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
                      <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
                        ...
                        <p className="text-base leading-7 font-montserrat">Copyright 2023 By T-Gus Davidson. All Rights Reserved</p>
                      </div>
